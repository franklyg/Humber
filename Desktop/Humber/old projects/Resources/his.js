var hisWorkoutWin = Ti.UI.createWindow({
	width: 360,
	left: 0,
	top: 0,
...
var rows = [
	{ title: 'Abs', backgroundColor: '#3f3f3f', hasChild: true, color: '#f7e8c6',workColor: '/malePage.jpg', url: '/Male/Mabs.js' },
	{ title: 'Chest', backgroundColor: '#3f3f3f', hasChild: true,workColor: '/malePage.jpg', color: '#f7e8c6', url: '/Male/Mchest.js'},
	{ title: 'Arms', backgroundColor: '#3f3f3f' , hasChild: true,workColor: '/malePage.jpg', color: '#f7e8c6' , url: '/Male/Marms.js'},
	{ title: 'Legs', backgroundColor: '#3f3f3f' , hasChild: true,workColor: '/malePage.jpg', color: '#f7e8c6' , url: '/Male/Mlegs.js'},
	{ title: 'Stretches', backgroundColor: '#3f3f3f' , hasChild: true,workColor: '/malePage.jpg', color: '#f7e8c6' , url: '/Male/Mstretches.js'},
];
...
hisWorkoutWin.add(workoutHeader);
/**************************************************************************************************************************************/
...
hisWin.backgroundImage = 'malePage.jpg';
...
hisWin.setLeftNavButton(slideBtn);
...
hisWin.addEventListener('touchstart', function(e){
	e.source.axis = parseInt(e.x);
});

hisWin.addEventListener('touchmove', function(e){
	var coordinates = parseInt(e.globalPoint.x) - e.source.axis;
	if (coordinates > 20 || coordinates < -20){
		e.source.moving = true;
	}
...
hisWin.addEventListener('touchend', function(e){
	e.source.moving= false;
	if(mainWin.left >= 75 && mainWin.left < 360){
		mainWin.animate({
			left: 360,
