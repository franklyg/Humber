...
.d {color: #F00; }
body {background: #69F;}
#submit:hover {cursor: pointer; background: #fff;}
#outwrapper 
...
input {padding: 3px; width: 250px; border-radius: 5px;}
textarea {border-radius: 5px;}

h1{color: white; font-size: 52px; font-weight: bold; font-family: "Trebuchet MS", Arial, Helvetica, sans-serif; padding: 10px; border-bottom: 1px solid white; }
h2{color: white; font-size: 38px; font-family: "Trebuchet MS", Arial, Helvetica, sans-serif;}
#slogan { color: white; font-size: 18px; font-family: "Trebuchet MS", Arial, Helvetica, sans-serif; float: right;}
...
#wrapper { width: 960px; margin: 0 auto; padding: 10px; margin-top: 30px; border-left: 1px solid black; border-right: 1px solid black; background: #CCC;}
...
<body>
<p id = "slogan">"We know what you're doing!!"</p>
<h1>stalkMe</h1>
